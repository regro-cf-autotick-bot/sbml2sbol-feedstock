...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sbml2sbol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14190&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sbml2sbol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sbml2sbol` can be installed with:

```
conda install sbml2sbol
```

It is possible to list all of the versions of `sbml2sbol` available on your platform with:
